...
async def final_clean():
    ...
    try:
        ...
        for i in range(1, 5):
            await sovereign_service.hard_reset_slot(i, reason="Reset Final para V80.6")
            print(f"Slot {i} resetado.")
        
        # Clear System Message
        await sovereign_service.update_system_state("SCANNING", 0, "Pronto para teste V80.6", protocol="Sniper V15.1")
