...
async def nuclear_reset():
    ...
    for i in range(1, 5):
        await sovereign_service.free_slot(i, reason="NUCLEAR_RESET_V110_171")
    ...
    try:
        ...
        genesis_docs = await aio.to_thread(sovereign_service.db.collection("orders_genesis").get)
        deleted_g = 0
    ...
    if os.path.exists(paper_path):
        ...
        await sovereign_service.update_paper_state(empty_data)
