    ...
    try:
        ...
        if hype_moons:
            for m in hype_moons:
                ...
                await sovereign_service.remove_moonbag(m_id, reason="PURGE_GHOST_ROI_CORRUPT")
        else:
        ...
        if sovereign_service.rtdb:
            ...
            try:
                outcomes_ref = sovereign_service.rtdb.child("signals_v110").child("outcomes")
        ...
        try:
            genesis_ref = sovereign_service.db.collection("genesis_orders")
