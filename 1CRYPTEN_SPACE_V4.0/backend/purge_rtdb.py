...
async def purge_rtdb():
    ...
    for path in paths:
        try:
            ...
            await asyncio.to_thread(firebase_service.rtdb.child(path).delete)
    ...
    await asyncio.to_thread(firebase_service.rtdb.child('system/bankroll').set, initial_bankroll)
